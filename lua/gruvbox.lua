...
local function get_groups()
  ...
  local groups = {
    ...
    NormalFloatBg = { fg = colors.fg1, bg = colors.bg0 },
    ...
    StatusLine = { fg = colors.bg2, bg = colors.fg1, reverse = config.invert_status },
    StatusLineNC = { fg = colors.bg1, bg = colors.fg4, reverse = config.invert_status },
